...
export class EnhanceColumnNames1514009935606 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."session" ADD CONSTRAINT "fk_978571afb24326c18bd04262803" FOREIGN KEY ("user_id") REFERENCES "user"("id")`);
        await queryRunner.query(`ALTER TABLE "public"."message" ADD CONSTRAINT "fk_684f06a81d3f144920b6790c521" FOREIGN KEY ("owner_id") REFERENCES "user"("id")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."message" ADD CONSTRAINT "fk_c39f3f3b187c194fe5a05161da2" FOREIGN KEY ("") REFERENCES ""("")`);
        await queryRunner.query(`ALTER TABLE "public"."session" ADD CONSTRAINT "fk_befa332be8da6956e9e44a3e39a" FOREIGN KEY ("") REFERENCES ""("")`);
        ...
        await queryRunner.query(`ALTER TABLE "public"."cofirmation" ADD "updatedAt" TIMESTAMP(6) NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "public"."cofirmation" ADD "createdAt" TIMESTAMP(6) NOT NULL DEFAULT now()`);
    }
